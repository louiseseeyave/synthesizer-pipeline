...
data_dir = "/cosma7/data/dp004/dc-seey1/modules/synthesizer-pipeline/FLARES/data"

master_f = h5py.File(f"flares_photometry_{region}.hdf5", 'a')

for snap in snaps:

    fname = f"flares_photometry_{region}_{snap}.hdf5"
